export const text = {
    saveCommand: {
        notification: {
            save: (x, y, z, name) => `§7[§fSave | Command§7] §aSaved §flocation §7(§f${x}§7, §f${y}§7, §f${z}§7) §fas §7"§r${name}§7"`,
            teleport: (x, y, z, name) => `§7[§fSave | Command§7] §dTeleported §fto §7(§f${x}§7, §f${y}§7, §f${z}§7) §fas §7"§r${name}§7"`,
    ...
    coordinate: {
        ...
        actionbar: {
            ...
            positional: (x, y, z) => `Pos: ${x} / ${y} / ${z}`,
            rotational: (x, y) => `Rot(y/p): ${y} / ${x}`,
            interaction: {
